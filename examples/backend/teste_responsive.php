...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../plugins/datatables/media/css/responsive.dataTables.css">
	...
	<script type="text/javascript" language="javascript" src="../plugins/datatables/media/js/jquery.dataTables.js">
	</script>
    <script type="text/javascript" language="javascript" src="../plugins/datatables/media/js/dataTables.responsive.js">
	</script>
	<script type="text/javascript" language="javascript" src="../datatable/examples/resources/syntax/shCore.js">
	</script>
	<script type="text/javascript" language="javascript" src="../datatable/examples/resources/demo.js">
	</script>
