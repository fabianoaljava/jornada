                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <form class="panel panel-default form-horizontal form-bordered"
                            ...
                            data-options='{ "url": "<?php echo ROOTPATH; ?>usuario/update", "validate": true }'
                        >
                            ...
                            <div class="panel-body pt0">
								...
								$size = 150;
								$default = THEMEPATH . '/image/avatar/avatar.png';
								
								$foto = ($foto == '')? "http://www.gravatar.com/avatar/" . md5( strtolower( trim( $email ) ) ) . "?d=" . urlencode( $default ) . "&s=" . $size:ROOTPATH . $foto;
								?>
                                <input type="hidden" name="id" value="<?php echo (isset($id))?$id:''; ?>">                               
                                <input type="hidden" name="foto" id="foto" value="<?php echo (isset($foto))?$foto:''; ?>">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Foto do Perfil</label>
                                    <div class="col-sm-6">
                                        <div class="btn-group pr5">
                                            <img class="img-circle img-bordered" id="imgfoto" src="<?php echo (isset($foto))?$foto:''; ?>" alt="" width="34px">
                                        </div>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li><a href="#" id="removerfoto">Remover foto</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <?php if ($_SESSION['s_nivel_id'] == 1): ?>
								<div class="form-group">
                                    <label class="col-sm-3 control-label">Nível de Usuário<span class="text-danger">*</span></label>
                                        ...
                                        <select class="form-control" name="nivel_id"
                                                ...
                                                data-parsley-error-message="Por favor, preencha o campo Nível de Usuário">
                                                	...
                                                	<option value="<?=$nivel->id?>" <?=($nivel_id== $nivel->id)?'selected':'';?>><?=$nivel->nivel?></option>
	                                                <?php endforeach; ?> 
                                        </select>
										</div>
								</div>
                                ...
                                <input type="hidden" name="nivel_id" value="<?php echo (isset($nivel_id))?$nivel_id:''; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
										<input type="text" name="username" class="form-control" placeholder="Nome do Usuario"  data-parsley-required="true" data-parsley-error-message="Por favor, preencha o campo Nome do Usuário" autocomplete="off" value="<?php echo (isset($login))?$login:''; ?>">
                                    </div>
                                    <label class="col-sm-2 control-label">Senha<span class="text-danger">*</span></label>
                                    <div class="col-sm-3">
										<input type="password" name="newpassword" class="form-control" placeholder="Não alterada"  autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="nome" class="form-control" placeholder="Nome" data-parsley-required="true" data-parsley-error-message="Por favor, preencha o campo Nome" value="<?php echo (isset($nome))?$nome:''; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row mb5">
                                            <div class="col-xs-12">
                                                <input type="text" name="endereco" class="form-control" placeholder="Endereço (Rua, Av, etc), número, complemento" value="<?php echo (isset($endereco))?$endereco:''; ?>">
                                            </div>
                                        </div>          
                                        <div class="row mb5">
                                            <div class="col-xs-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="telefone_residencial" class="form-control" placeholder="Tel. Residencial"  data-mask="(99)9999-9999" value="<?php echo (isset($telefone_residencial))?$telefone_residencial:''; ?>">
                                    </div>
                                    <label class="col-sm-2 control-label">Telefone Com.</label>
                                    <div class="col-sm-3">
                                        <input type="text" name="telefone_comercial" class="form-control" 
                                        placeholder="Tel. Comercial" data-mask="(99)9999-9999"  value="<?php echo (isset($telefone_comercial))?$telefone_comercial:''; ?>">
                                    </div>
                                </div>  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="celular1" class="form-control" placeholder="Celular Principal" data-mask="(99)*9999-9999"   value="<?php echo (isset($celular1))?$celular1:''; ?>">
                                    </div>

                                    <label class="col-sm-2 control-label">Celular 2</label>
                                    <div class="col-sm-3">
                                        <input type="text" name="celular2" class="form-control" placeholder="Celular Alternativo" data-mask="(99)*9999-9999"   value="<?php echo (isset($celular2))?$celular2:''; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control" name="data_nasc" id="datepicker1" placeholder="Data de Nascimento"    value="<?php echo (isset($data_nasc))?$data_nasc:''; ?>">
                                    </div>
                                    
                                    <label class="col-sm-2 control-label">Data de Batismo</label>
                                    <div class="col-sm-3">
                                        
                                        <input type="text" class="form-control" name="data_batismo" id="datepicker2" placeholder="Data de Batismo"  value="<?php echo (isset($data_batismo))?$data_batismo:''; ?>" >
                                    </div>                                   
                                </div>                                
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        name="sobre" 
                                        rows="8" placeholder="Fale um pouco sobre você."><?php echo (isset($sobre))?$sobre:''; ?></textarea>
...
<div class="input-group">
								<input type="text" class="form-control" readonly="true"  id="newphoto"  >
