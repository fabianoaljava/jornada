                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <form class="panel panel-default form-horizontal form-bordered"
                            ...
                            data-options='{ "url": "<?php echo ROOTPATH; ?>culto/update", "validate": true }'
                        >
                            <div class="panel-heading"><h5 class="panel-title">Cultos</h5></div>
                            <div class="panel-body pt0">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
										<input type="text" name="nome_culto" class="form-control" placeholder="Nome do Culto"  data-parsley-required="true" data-parsley-error-message="Por favor, preencha o campo Nome do Culto" autocomplete="off" value="<?=$nome_culto?>">
                                    </div>
...
<div class="input-group">
                             ...
                             <div class="panel-body pt0 pb0 panel-photo">                                    
								...
								<form 
                                 ...
                                 id="form_crop"
                                data-toggle="formajax" 
                                data-options='{ "url": "<?php echo ROOTPATH; ?>culto/crop", "validate": true }'
                                >       
