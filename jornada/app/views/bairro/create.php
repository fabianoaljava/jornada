                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <form class="panel panel-default form-horizontal form-bordered"
                            ...
                            data-options='{ "url": "<?php echo ROOTPATH; ?>bairro/insert", "validate": true }'
                        >
                            ...
                            <div class="panel-body pt0">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
										<input type="text" name="nome_bairro" class="form-control" placeholder="Nome do Bairro"  data-parsley-required="true" data-parsley-error-message="Por favor, preencha o campo Nome do Bairro" autocomplete="off">
                                    </div>
