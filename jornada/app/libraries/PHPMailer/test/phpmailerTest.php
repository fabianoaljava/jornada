...
require_once '../../../../../painel/koinonia/libraries/PHPMailer/PHPMailerAutoload.php';
...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        if (file_exists('../../../../../painel/koinonia/libraries/PHPMailer/test/testbootstrap.php')) {
            include '../../../../../painel/koinonia/libraries/PHPMailer/test/testbootstrap.php'; //Overrides go in here
        }
...
EOT;
    ...
    public function testIcal()
    {
        ...
        $this->Mail->isHTML(true);
        $this->buildBody();
        require_once '../../../../../painel/koinonia/libraries/PHPMailer/extras/EasyPeasyICS.php';
