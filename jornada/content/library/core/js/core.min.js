 ...
 * ======================================================================== */
!function(e,t,n,s){function o(t,n){this.element=t,this.settings=e.extend({},d,n),this._defaults=d,this._name=a,this.init()}var a="Core",i=!1,l=!1,r=!1,c=!1,p=!1,d={console:!1,loader:!0,eventPrefix:"fa",breakpoint:{lg:1200,md:992,sm:768,xs:480}};o.prototype={init:function(){this.MISC.Init(),this.PLUGINS(),this.VIEWPORTWATCH(),this.WINLOADER()},HELPER:{Console:function(t){settings.console&&e(element).on(t,function(e,n){console.log("----- "+t+" -----"),console.log(n.element)})}},WINLOADER:function(){element=this.element,settings=this.settings,settings.loader&&(NProgress.start(),e(t).load(function(){NProgress.done()}))},VIEWPORTWATCH:function(){element=this.element,settings=this.settings,Response.action(function(){Response.band(settings.breakpoint.lg)&&(l=!0,r=!1,c=!1,p=!1,i=!!e(element).hasClass("sidebar-minimized")),Response.band(settings.breakpoint.md,settings.breakpoint.lg-1)&&(l=!1,r=!0,c=!1,p=!1,i=!!e(element).hasClass("sidebar-minimized")),Response.band(settings.breakpoint.sm,settings.breakpoint.md-1)&&(l=!1,r=!1,c=!0,p=!1,i=!1),Response.band(0,settings.breakpoint.xs)&&(l=!1,r=!1,c=!1,p=!0,i=!1)})},MISC:{Init:function(){this.ConsoleFix(),this.Scrollbar(".slimscroll"),this.Fastclick(),this.Unveil(),this.BsTooltip(),this.BsPopover(),this.Stellar(),this.InputPlaceholder()},ConsoleFix:function(){for(var e,n=function(){},s=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],o=s.length,a=t.console=t.console||{};o--;)e=s[o],a[e]||(a[e]=n)},Scrollbar:function(t){e(".no-touch "+t).each(function(t,n){e(n).slimScroll({size:"8px",distance:"0px",wrapperClass:e(n).data("wrapper")||"viewport",railClass:"scrollrail",barClass:"scrollbar",wheelStep:10,railVisible:!0,alwaysVisible:!0})})},Fastclick:function(){FastClick.attach(n.body)},Unveil:function(){e("[data-toggle~=unveil]").unveil(200,function(){e(this).load(function(){e(this).addClass("unveiled")})})},BsTooltip:function(){e("[data-toggle~=tooltip]").tooltip()},BsPopover:function(){e("[data-toggle~=popover]").popover()},Stellar:function(){e(t).stellar({horizontalScrolling:!1})},InputPlaceholder:function(){e("input, textarea").placeholder()}},PLUGINS:function(){element=this.element,settings=this.settings,function(){var t="[data-toggle~=totop]";e(element).on("click",t,function(t){e("html, body").animate({scrollTop:0},200),t.preventDefault()})}(),function(){var t="[data-toggle~=waypoints]";e(t).each(function(){var t,n,s,o,a;o=e(this).data("marker")?e(this).data("marker"):this,s=e(this).data("offset")?e(this).data("offset"):"80%",t=e(this).data("showanim")?e(this).data("showanim"):"fadeIn",n=e(this).data("hideanim")?e(this).data("hideanim"):!1,a=e(this).data("trigger-once")?e(this).data("trigger-once"):!1,e(o).waypoint(function(s){"down"===s&&e(this).removeClass(n+" animated").addClass(t+" animating").on("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){e(this).removeClass("animating").addClass("animated").removeClass(t)}),"up"===s&&n!==!1&&e(this).removeClass(t+" animated").addClass(n+" animating").on("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){e(this).removeClass("animating").removeClass("animated").removeClass(n)})},{offset:s,triggerOnce:a,continuous:!0})})}(),function(){function t(t,n){s=e(t).data("contextual")?e(t).data("contextual"):"active","checked"===n?(e(t).parents(i).addClass(s),e(element).trigger(settings.eventPrefix+".selectrow.selected",{element:e(t).parents(i)})):(e(t).parents(i).removeClass(s),e(element).trigger(settings.eventPrefix+".selectrow.unselected",{element:e(t).parents(i)}))}var s,a="[data-toggle~=selectrow]",i=e(a).data("target");e(a).each(function(){e(this).is(":checked")&&t(this,"checked")}),e(n).on("change",a,function(){e(this).is(":checked")?t(this,"checked"):t(this,"unchecked")}),o.prototype.HELPER.Console(settings.eventPrefix+".selectrow.selected"),o.prototype.HELPER.Console(settings.eventPrefix+".selectrow.unselected")}(),function(){function t(t){e(t).find("input[type=checkbox]").each(function(){"selectrow"===e(this).data("toggle")&&(e(this).is(":checked")||e(this).prop("checked",!0).trigger("change"))}),e(element).trigger(settings.eventPrefix+".checkall.checked",{element:e(t)})}function s(t){e(t).find("input[type=checkbox]").each(function(){"selectrow"===e(this).data("toggle")&&e(this).is(":checked")&&e(this).prop("checked",!1).trigger("change")}),e(element).trigger(settings.eventPrefix+".checkall.unchecked",{element:e(t)})}var a="[data-toggle~=checkall]";e(a).each(function(){e(this).is(":checked")&&t()}),e(n).on("change",a,function(){var n=e(this).data("target");e(this).is(":checked")?t(n):s(n)}),o.prototype.HELPER.Console(settings.eventPrefix+".checkall.checked"),o.prototype.HELPER.Console(settings.eventPrefix+".checkall.unchecked")}(),function(){var t=!1,n="indicator",s="[data-toggle~=panelrefresh]";e(element).on("click",s,function(s){var o=e(this).parents(".panel"),a=o.find("."+n);t=e(this).hasClass("demo")?!0:!1,0!==a.length?(a.addClass("show"),t&&setTimeout(function(){a.removeClass("show")},2e3),e(element).trigger(settings.eventPrefix+".panelrefresh.refresh",{element:e(o)})):e.error("There is no `indicator` element inside this panel."),s.preventDefault()}),o.prototype.HELPER.Console(settings.eventPrefix+".panelrefresh.refresh")}(),function(){var t="[data-toggle~=panelcollapse]";e(element).on("click",t,function(t){function n(t){e(t).removeClass("down").addClass("up"),e(a).removeClass("pull").addClass("pulling").css("height","0px").transition({height:i},function(){e(this).removeClass("pulling").addClass("pull out"),e(this).css({height:""})}),e(element).trigger(settings.eventPrefix+".panelcollapse.open",{element:e(o)})}function s(t){e(t).removeClass("up").addClass("down"),e(a).removeClass("pull out").addClass("pulling").css("height",i).transition({height:"0px"},function(){e(this).removeClass("pulling").addClass("pull"),e(this).css({height:""})}),e(element).trigger(settings.eventPrefix+".panelcollapse.close",{element:e(o)})}var o=e(this).parents(".panel"),a=o.children(".panel-collapse"),i=a.height();0===a.length&&e.error("collapsable element need to be wrap inside '.panel-collapse'"),e(a).hasClass("out")?s(this):n(this),t.preventDefault()}),o.prototype.HELPER.Console(settings.eventPrefix+".panelcollapse.open"),o.prototype.HELPER.Console(settings.eventPrefix+".panelcollapse.close")}(),function(){var t,n,s="[data-toggle~=panelremove]";e(element).on("click",s,function(s){t=e(this).parents(".panel"),n=e(this).data("parent"),t.transition({scale:0},function(){n?e(this).parents(n).remove():e(this).remove(),e(element).trigger(settings.eventPrefix+".panelcollapse.remove",{element:e(t)})}),s.preventDefault()}),o.prototype.HELPER.Console(settings.eventPrefix+".panelremove.remove")}(),function(){function t(t){e(element).hasClass("sidebar-minimized")?(i=!1,e(element).removeClass("sidebar-minimized"),e(this).removeClass("minimized"),e(element).trigger(settings.eventPrefix+".sidebar.maximize",{element:e(element)})):(i=!0,e(element).addClass("sidebar-minimized"),e(this).addClass("minimized"),e(element).trigger(settings.eventPrefix+".sidebar.minimize",{element:e(element)})),t.preventDefault()}var n="[data-toggle~=minimize]";e(element).on("click",n,t),o.prototype.HELPER.Console(settings.eventPrefix+".sidebar.minimize"),o.prototype.HELPER.Console(settings.eventPrefix+".sidebar.maximize")}(),function(){function t(t){var n=e(this),s=n.data("parent"),o=n.data("target");"click"===t.type&&(e(o).hasClass("in")?(e(o).collapse("hide"),n.parent().removeClass("open")):(s&&e(s+" .in").each(function(){e(this).collapse("hide"),e(this).parent().removeClass("open")}),e(o).collapse("show"),n.parent().addClass("open"))),(c||i)&&!!o==!0&&e(element).hasClass("touch")&&"click"===t.type&&(n.parent().hasClass("hover")?(n.parent().removeClass("hover"),e(o).css("top","")):(s&&e(s+" .hover").each(function(t,n){e(n).removeClass("hover")}),n.parent().addClass("hover"),e(o)[0].getBoundingClientRect().bottom>=Response.viewportH()&&e(o).css("top","-"+(e(o)[0].getBoundingClientRect().bottom-Response.viewportH()+2)+"px")))}function s(t){var n=e(this),s=(n.children(a).data("parent"),n.children(a).data("target"));(c||i)&&!!s==!0&&(e(element).hasClass("touch")||("mouseenter"===t.type&&(n.addClass("hover"),e(s)[0].getBoundingClientRect().bottom>=Response.viewportH()&&e(s).css("top","-"+(e(s)[0].getBoundingClientRect().bottom-Response.viewportH()+2)+"px")),"mouseleave"===t.type&&(n.removeClass("hover"),e(s).css("top",""))))}var o="[data-toggle~=menu]",a="[data-toggle~=submenu]";e(n).on("click",a,t).on("mouseenter mouseleave",o+" > li",s)}(),function(){function t(){return i=e(this).data("direction"),l="ltr"===i?".sidebar-left":".sidebar-right",(i===!1||""===i)&&e.error("missing `data-direction` value (ltr or rtl)"),e(element).hasClass(c+"-"+i)?a():s(),!1}function s(){e(element).addClass(c+"-"+i),e(element).trigger(settings.eventPrefix+".sidebar.open",{element:e(l)})}function a(){e(element).hasClass(c+"-"+i)&&(e(element).removeClass(c+"-"+i),e(element).trigger(settings.eventPrefix+".sidebar.close",{element:e(l)}))}var i,l,r="[data-toggle~=sidebar]",c="sidebar-open";e(n).on("click",a).on("click",".sidebar,"+r,function(e){e.stopPropagation()}).on("click",r,t),o.prototype.HELPER.Console(settings.eventPrefix+".sidebar.open"),o.prototype.HELPER.Console(settings.eventPrefix+".sidebar.close")}(),function(){function t(){function t(){var t=e.ajax({type:i.method||"post",url:i.url,dataType:"json",data:o.serialize()});if(e(n).hasClass("ladda-button"))var s=Ladda.create(n).start();else e(n).prop("disabled",!0);t.done(function(t){e(n).hasClass("ladda-button")?s.stop():e(n).prop("disabled",!1),e(element).trigger(settings.eventPrefix+".formajax.done",{element:o,response:t})}),t.fail(function(t){e(n).hasClass("ladda-button")?s.stop():e(n).prop("disabled",!1),e(element).trigger(settings.eventPrefix+".formajax.fail",{element:o,response:t})})}var n=this,o=e(this).parents(s),i=o.data("options");"object"!=typeof i&&a.push("`data-options` need to be a valid javascript object!"),i.validate&&!jQuery().parsley&&a.push("please include `parsley` plugin for form validation!"),a.length<=0?i.validate===!0?o.parsley().validate()&&t():t():e.each(a,function(t,n){e.error(n)})}var s="[data-toggle~=formajax]",a=[];e(n).on("submit",s,function(e){e.preventDefault()}).on("click",s+" button[type=submit]",t),o.prototype.HELPER.Console(settings.eventPrefix+".formajax.always"),o.prototype.HELPER.Console(settings.eventPrefix+".formajax.done"),o.prototype.HELPER.Console(settings.eventPrefix+".formajax.fail")}(),e(function(){var t="[data-toggle~=counterup]",n=[];e(t).each(function(t,s){options=e(s).data("options"),n.length<=0?e(s).counterUp({delay:10,time:1e3}):e.each(n,function(t,n){e.error(n)})})}),e(function(){var t="[data-toggle~=offcanvas]",n=[];e(t).each(function(t,o){var a=e(o).data("options");a!==s?"object"!=typeof a?n.push("OffCanvas: `data-options` need to be a valid javascript object!"):(optOpenerClass=a.openerClass||"offcanvas-opener",optCloserClass=a.closerClass||"offcanvas-closer"):(optOpenerClass="offcanvas-opener",optCloserClass="offcanvas-closer"),n.length<=0?e(o).on("click","."+optOpenerClass,function(t){var n=e(this).hasClass("offcanvas-open-rtl")?"offcanvas-open-rtl":"offcanvas-open-ltr";e(o).removeClass("offcanvas-open-ltr offcanvas-open-rtl").addClass(n),e(element).trigger(settings.eventPrefix+".offcanvas.open",{element:e(o)}),t.preventDefault()}).on("click","."+optCloserClass,function(t){e(o).removeClass("offcanvas-open-ltr offcanvas-open-rtl"),e(element).trigger(settings.eventPrefix+".offcanvas.close",{element:e(o)}),t.preventDefault()}):e.each(n,function(t,n){e.error(n)})}),o.prototype.HELPER.Console(settings.eventPrefix+".offcanvas.open"),o.prototype.HELPER.Console(settings.eventPrefix+".offcanvas.close")})}},e.fn[a]=function(t){return this.each(function(){e.data(this,a)||e.data(this,a,new o(this,t))})}}(jQuery,window,document);